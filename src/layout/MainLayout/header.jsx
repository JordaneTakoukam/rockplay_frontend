...
const useStyles = makeStyles(() => ({
    ...
    LogoBox: {
        ...
        gap: '21px',
        marginLeft: 0, // Par défaut, pas de marge sur les petits écrans
    ...
    ChatButton: {
        ...
        "@media (min-width: 764px)": {
            marginRight: '30px', // Appliquer une marge gauche uniquement à partir du desktop
        },
    },
    ProfileButton: {
        borderRadius: '50%',
        ...
        width: "50px",
        height: "47px",
        "@media (min-width: 1024px)": { // Supposons que le breakpoint pour desktop commence à 1024px
            marginRight: '30px',
        },
    },
    HeaderMiddleBox: {
    ...
    return (
        <header className={classes.MainHeaderBox}>
            <Box className={classes.LogoBox}>
                ...
                <Link to={'/app/home'}  > <LogoIcon className={classes.LogoIcon} /></Link>
            </Box>
