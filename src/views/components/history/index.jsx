...
const useStyles = makeStyles(() => ({
  ...
  TransactionCoinIcon: { width: 40, height: 40 },
  ...
  const getStatusInfo = (item) => {
    if (item.type_transaction === "deposit") {
      ...
      return {
        ...
        icon: <AddIcon style={{ color: "#4caf50" }} />,
        color: "#4caf50",
        isDeposit: true,
      };
    }
              ...
              <Box key={index} className={classes.TransactionRow}>
                ...
                <Box className={classes.TransactionRowContent}>
                  <Box className={classes.TransactionContent}>
                    ...
                    <Typography className={classes.TxId}>{getDisplayId()}</Typography>
                  </Box>
