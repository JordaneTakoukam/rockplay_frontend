...
import { configPlayAmount, roundToCurrencyPrecision } from "config/config_play_amount";
...
const Mines = () => {
    ...
    const images = [
        '/assets/images/mines/background.png',
        '/assets/images/mines/woman.png',
        '/assets/images/mines/cat.png',
        '/assets/images/mines/DiamondIcon.png',
        '/assets/images/mines/MinesCardBg.png',
    ...
    const payoutAmount = roundToCurrencyPrecision(
        Number(betAmount * curPayout),
        (currency?.coinType?.toLowerCase() || 'btc'),
        9
    ...
    const onWindowMessage = (event) => {
        ...
        if (event?.data?.type === 'playzelo-mines-roundResult') {
            ...
            if (event.data.data.roundResult == 'payout') {
                addToast('You won this round', { appearance: 'success', autoDismiss: true });

            }
            else if (event.data.data.roundResult == 'lost') {
