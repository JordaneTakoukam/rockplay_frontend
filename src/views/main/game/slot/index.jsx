...
const SlotGame = () => {
    ...
    const images = [
        "/assets/images/slot/background.jpg",
        "/assets/images/slot/panelbg.png",
        "/assets/images/slot/selectbg.png",
        "/assets/images/slot/inputbg.png",
        "/assets/images/slot/betbuttonbg.png",
        "/assets/images/slot/gamebg.jpg",  // Exemple d'image supplémentaire
        "/assets/images/slot/reelbg.png",  // Autre exemple d'image
        "/assets/images/slot/winbg.png",   // Exemple d'image de fond pour un état gagné
        "/assets/images/slot/matchbg.png"  // Exemple d'image pour un état matché
    ];
