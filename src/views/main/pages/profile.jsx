            ...
            <Box className={classes.ProfileContainer}>
                ...
                <Box className={classes.UserInfoBox}>
                    <Box className={classes.UserAvatarBox}>
                        ...
                        <Box className={classes.UserDetailBox}>
                            ...
                            <span className={classes.UserNameText}>{authData.userData.userName}</span>
                        ...
                        <Box className={classes.AmountDetailBox}>
                            ...
                            <Box className={classes.AmountBox}>
                                ...
                                <Box className={classes.AmountLabel}>
                                    <CoinIcon />
                                    {profileData ? roundToCurrencyPrecision(Number(profileData?.countData?.betAmount), 'btc') : 0}
                                </Box>
                            </Box>
                        </Box>
                    </Box>
                ...
                <Box className={classes.HistoryBox}>
                    ...
                    <Box className={classes.HistoryDataBox}>
                        ...
                        <Box className={clsx(classes.TableDataBox)} ref={historyRef}>
                            {
