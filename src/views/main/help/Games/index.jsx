...
const HelpGameBox = () => {
    ...
    const subCategory = [
        ...
        // add
        { text: 'How to play plinko', link: '/app/help/games/how-to-play/plinko' },
        { text: 'How to play slot', link: '/app/help/games/how-to-play/slot' },
        { text: 'How to play crash', link: '/app/help/games/how-to-play/crash' },
    ];
